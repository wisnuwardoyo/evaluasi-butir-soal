 ...
 * @author Wisnu Citra
 */
public class AnsPanel extends javax.swing.JPanel implements AnsListener {
    JList listRowHeader;
    String[] rowHeader;
    String[] colHeader;
    String[][] dataTable;
    ...
    @Override
    public void onLoad() {
        this.row = Integer.parseInt(model.getJmlSiswa()[model.getBerkasAktif()]);
        this.col = Integer.parseInt(model.getJmlSoal()[model.getBerkasAktif()]);

        rowHeader = new String[this.row];
        colHeader = new String[this.col + 1];
        dataTable = new String[this.row][this.col + 1];
        ...
        dataTable = model.getSoal()[model.getBerkasAktif()];

//        for (int i = 0; i < this.row; i++) {
//            dataTable[i][0] = "Siswa " + (i + 1);
//        }
    ...
    public void setModel(MainModel model) {
        this.model = model;
        this.model.setAnsListener(this);
    }

    public void setController(MainController controller) {
        this.controller = controller;
        this.controller.setModel(model);
        this.controller.ansLoad();
    }
    ...
    public void setTable() {
        ...
        for (int i = 1; i < table.getColumnCount(); i++) {
            table.getColumnModel().getColumn(i).setCellRenderer(new TableCellListener(Integer.parseInt(model.getTipeSoal()[model.getBerkasAktif()])));
        }
