...
public class MainFrame extends javax.swing.JFrame implements MainListener {
        ...
        if (maintenance) {
            ...
            if (result == 0) {
                if (newDocumentPanel.itemCheck()) {
                    ...
                    controller.newDocument(newDocumentPanel);
    ...
    public void loadDocument() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                controller.setBerkasAktif(0);
                controller.openingFile(openDialog.getSelectedFile().getCanonicalPath().toString());
            ...
            try {
                ...
                if (new File(path).exists() || new File(path+".xml").exists()) {
                    ...
                    if (confirm == 0) {
                        ...
                        controller.setKunci(keyPanel);
                        controller.setSoal(ansPanel);
                        saveFile.setModel(model);
                        saveFile.write(path);
                        controller.openingFile(path+".xml");
                        this.repaint();
                    }
    ...
    public void openResult() {
        ...
        resultPanel.setMainModel(model);
        resultPanel.setFrame(this);
    ...
    private void initComponents() {
        ...
        button_sc_key.setBackground(new Color(225,225,255,20));
        ...
        button_sc_ans.setBackground(new java.awt.Color(160, 160, 160));
        ...
        button_sc_res.setBackground(new java.awt.Color(160, 160, 160));
        ...
        button_sc_print.setBackground(new java.awt.Color(160, 160, 160));
        ...
        jLabel1.setText("EVALUASI BUTIR SOAL ");
    ...
    private void button_sc_keyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_sc_keyActionPerformed
        ...
        if (maintenance) {
            ...
            keyPanel.setModel(model);
            keyPanel.setController(controller);
            jScrollPane2.setViewportView(keyPanel);
    ...
    private void button_sc_ansActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_sc_ansActionPerformed
        ...
        if (maintenance) {
            ...
            ansPanel.setModel(model);
            ansPanel.setController(controller);
            jScrollPane2.setViewportView(ansPanel);
        } else {
            jScrollPane2.setViewportView(ansPanel);
        }
